...
export const CATALOGO: Material[] = [
  ...
  { id: 'G21', tipo: 'guia', emoji: '📖', codigo: 'G21', nome: 'O Segundo em Comando',                   desc: 'COO, 2IC e transição de autoridade operacional', acao: 'Acessar PDF', url: gdl('14Aqf0w-BqCnNLrW3oC24WJ3zhKx5Et7X'), modelos: ['H'] },
  { id: 'G22', tipo: 'guia', emoji: '📖', codigo: 'G22', nome: 'Retenção e Crescimento pela Base',       desc: 'Retenha clientes e reduza churn com método',     acao: 'Acessar PDF', url: gdl('1RmLSJiOLUAsHZdSlSCNbuAy9dIwJVv2l'), modelos: ['B','F','C'] },
  { id: 'G23', tipo: 'guia', emoji: '📖', codigo: 'G23', nome: 'Parcerias e Novos Canais de Crescimento',desc: 'Abra novos canais e parcerias estratégicas',     acao: 'Acessar PDF', url: gdl('1TUNuOnz-bG5G81urHPoWdKdsen3XV-l8'), modelos: ['X','B'] },
  // Templates
