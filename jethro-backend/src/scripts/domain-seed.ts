...
const onboardingQuestions: DiagnosticQuestionSeed[] = [
  ...
  },
  {
    ...
    helperText: 'Escreva livremente: nome e função de cada pessoa (ex: João — Vendas, Maria — Financeiro).',
    questionType: 'textarea',
    options: [],
    metadata: {
  ...
  },
  {
    ...
    helperText: 'Selecione a faixa. Você pode digitar um valor específico abaixo.',
